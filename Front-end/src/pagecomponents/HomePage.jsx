...
function HomePage() {
  ...
  }, [text, isDeleting, loopNum, typingSpeed, words, mounted]);
      ...
      <div id="home" className="bg-black min-h-screen">
        ...
        <main className="flex w-full justify-around flex-row pt-20 px-4 items-center min-h-screen">
          <div className="text-white flex flex-col space-y-6 max-w-lg">
            <div className="h-16 w-96 bg-gray-800 animate-pulse rounded"></div>
            <div className="h-24 w-full bg-gray-800 animate-pulse rounded"></div>
            <div className="flex space-x-4">
              <div className="h-14 w-32 bg-gray-800 animate-pulse rounded-3xl"></div>
              <div className="h-14 w-32 bg-gray-800 animate-pulse rounded-lg"></div>
            </div>
          </div>
          <div className="relative">
            <div className="w-[500px] h-[200px] bg-gray-800 animate-pulse rounded-2xl"></div>
          </div>
        </main>
      </div>
    );
