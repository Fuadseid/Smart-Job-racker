                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <DropdownMenu className="">
                          <DropdownMenuTrigger asChild>
                            <button className="p-1.5 hover:bg-white/10 focus:text-white/70 rounded-lg transition-colors cursor-pointer">
                              <MoreVertical className="h-4 w-4 text-white/60" />
                            </button>
                          </DropdownMenuTrigger>
                          <DropdownMenuContent className="bg-gray-900  border-white/10 focus:text-white/70  text-white">
                            <DropdownMenuItem
                              className="cursor-pointer focus:text-white/70 hover:bg-white/10 focus:bg-white/10"
                              onClick={() =>
                            ...
                            <DropdownMenuItem
                              className="cursor-pointer hover:bg-white/10 focus:bg-white/10 focus:text-red-400/70 text-red-400"
                              onClick={() => {
                                setSelectedJob(job);
