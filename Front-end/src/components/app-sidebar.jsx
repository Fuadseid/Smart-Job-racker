...
export function AppSidebar({
  ...
  return (
    <Sidebar {...props} className={`bg-black text-white border-r border-gray-800 `}>
              ...
              <Collapsible key={item.title} defaultOpen={index === 1} className="group/collapsible">
                <SidebarMenuItem>
                  <CollapsibleTrigger asChild>
                    <SidebarMenuButton className="text-gray-300 hover:text-white hover:bg-gray-800 data-[state=open]:text-white">
                      {item.title}{" "}
                        ...
                        {item.items.map((item) => (
                          <SidebarMenuSubItem key={item.title}>
                            <SidebarMenuSubButton 
                              ...
                              className={`text-gray-400 hover:text-white hover:bg-gray-800 ${item.isActive ? 'bg-gray-800 text-white' : ''}`}
                            >
